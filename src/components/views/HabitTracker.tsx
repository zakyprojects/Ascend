...
export function HabitTracker({ store }: { store: AppStore }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-3.5 bg-bg-800/90 rounded-xl border border-overlay-subtle flex items-start gap-2.5 text-xs text-content-muted">
        ...
        <div className="space-y-0.5">
          ...
          <p className="leading-relaxed">
            ...
            For <span className="text-content-secondary font-semibold">Below Diamond tier</span> (Bronze to Platinum), penalty escalation caps at <span className="text-amber-400 font-semibold">1.5x</span>.
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                    frequency === 'daily'
                      ...
                      : 'bg-bg-700 text-content-muted border border-overlay-subtle'
                  }`}
                >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {!habit.isPreset && !isLinked && (
              <span className="badge bg-slate-700/50 text-content-disabled shrink-0">
                Custom
              </span>
            )}
          </div>
